...
<project version="4">
  ...
  <component name="ChangeListManager">
    <list default="true" id="a61dba95-19e9-4520-84ca-97a8e76608f6" name="Default Changelist" comment="" />
  ...
  <component name="FileEditorManager">
    <leaf SIDE_TABS_SIZE_LIMIT_KEY="300">
      <file pinned="false" current-in-tab="true">
        <entry file="file://$PROJECT_DIR$/app/src/main/java/com/limpatprananda/plugin/simpleretrofit/MainActivity.kt">
          <provider selected="true" editor-type-id="text-editor">
            <state relative-caret-position="131">
              ...
              <folding>
                <element signature="e#50#432#0" expanded="true" />
              </folding>
            </state>
          </provider>
        </entry>
        ...
        <entry file="file://$PROJECT_DIR$/app/build.gradle">
          <provider selected="true" editor-type-id="text-editor">
            <state relative-caret-position="410">
              <caret line="40" column="52" selection-start-line="40" selection-start-column